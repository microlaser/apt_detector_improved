...
| Version | Summary |
|---------|---------|
| v13.0 | Fixed four false positives identified in live run: Little Snitch M2 FP, Apple tap M3 FP, SSV indeterminate on real hardware, kext header lines counted as kexts. Header updated with xattr include and public prototypes. |
